...
export class ListPerson {
    ...
    render() {
        ...
        for (let user of this.users) {
            ...
            <td>
            <button class="btn btn-secondary rounded" id="btnChiTiet" data-toggle="modal" data-target="#chiTietSinhVienModal">Chi tiết</button>
            <button class="btn btn-danger rounded" id="btnXoa" onclick="deleteUser(${newUser.id})">Xóa</button>
            <button class="btn btn-success rounded" id="btnXoa" onclick="updateUser(${newUser.id})" data-toggle="modal" data-target="#updateModal">Cập nhật</button>
            </td>
            </tr>
        `}
        return rowUser;
