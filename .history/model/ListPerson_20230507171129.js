    ...
    renderDesc(value, id) {
        if (value == 1) {
            ...
            rowUser += `
                ...
                <td class="tinhDiem"></td>
                <td>
                <button class="btn btn-primary rounded" id="btnTinhDiem" onclick="tinhDiem(${userSelected.id})">Tính Điểm</button>
                </td>
                </tr>
            `
            return rowUser;
            ...
            rowUser += `
                ...
                <td class="tinhLuong"></td>
                <td>
                <button class="btn btn-primary rounded" id="btnTinhDiem" onclick="tinhLuong(${userSelected.id})">Tính lương</button>
                </td>
                </tr>
            `
            return rowUser;
    ...
    renderHeader(value) {
        if (value == 1) {
            ...
            <tr>
                ...
                <th>Điểm Lý</th>
                <th>Điểm Hóa</th>
                <th class="diemTrungBinh">Điểm Trung Bình</th>
            ...
            <tr>
                ...
                <th class="tongLuong">Tổng lương</th>
                <th><em class="fa fa-cog"></em></th>
            </tr>
            `
            return rowHeader;
