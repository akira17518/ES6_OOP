...
export class ListPerson {
    ...
    render() {
        ...
        for (let user of this.users) {
            ...
            <td>
            <button class="btn btn-primary rounded" id="btnChiTiet" data-toggle="modal" data-target="#chiTietSinhVienModal" onclick="renderChiTiet(${newUser.id})">Chi tiết</button>
