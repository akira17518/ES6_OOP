...
document.querySelector(".modal-body #form").onchange = () => {
    ...
    console.log((rowKhachHangThongBao[1]));
    ...
    if (userEnum == 1) {
        ...
        // Reset các lỗi
        rowNhanVienThongBao.forEach(item => reset(item));
        rowKhachHangThongBao.forEach(item => reset(item));
        ...
        // Reset các lỗi
        rowSinhVienThongBao.forEach(item => reset(item));
        rowKhachHangThongBao.forEach(item => reset(item));
    } else if (userEnum == 3) {
        document.querySelector(".sinhVienInputContainer").style.display = "none";
        document.querySelector(".nhanVienInputContainer").style.display = "none";
