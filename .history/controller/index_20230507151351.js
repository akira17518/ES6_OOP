...
document.querySelector("#btnUpdateUser").addEventListener("click", function () {
    ...
    if (userEnum == 0) {
        ...
        userList.save();
        document.querySelector("#tableDanhSach").innerHTML = userList.render(1);
        document.querySelector("#tbUser").innerHTML = "";
        document.querySelector("#btnThemUser").disabled = false;
    } else if (userEnum == 2) {
        let user = new Employee();
        ...
        userList.updateUser(user.id, user);
        userList.save();
        document.querySelector("#tableDanhSach").innerHTML = userList.render(2);
        document.querySelector("#tbUser").innerHTML = "";
        document.querySelector("#btnThemUser").disabled = false;
        ...
        userList.updateUser(user.id, user);
        userList.save();
        document.querySelector("#tableDanhSach").innerHTML = userList.render(3);
        document.querySelector("#tbUser").innerHTML = "";
        document.querySelector("#btnThemUser").disabled = false;
    }
    document.querySelector('[data-dismiss="modal"]').click();
