...
let sortBy = thName.setAttribute("sort-by", "esc");
thName.onclick = () => {
    ...
    if (sortBy == "esc") {
        ...
        document.querySelector(".fa fa-arrow-up").style.display = none;
    } else {
        sortBy = thName.setAttribute("sort-by", "esc");
        document.querySelector(".fa fa-arrow-down").style.display = none;
    }
