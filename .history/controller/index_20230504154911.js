...
document.querySelector("#btnThemUser").addEventListener("click", function() {
    ...
    let rowNhanVienInput = document.querySelectorAll(".sinhVienInputContainer input");
    let rowKhachHangInput = document.querySelectorAll(".sinhVienInputContainer input");
})